...
- Videos should be placed in data/assets/raw_out_videos/
- See data/assets/raw_out_videos/README.md for detailed instructions
"""
...
logger = utils.setup_logging(log_file='data/assets/raw_out_videos/preparation.log')
