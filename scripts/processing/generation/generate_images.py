...
Prompts are loaded from data/assets/raw_images/prompts.txt (one per line).
...
Usage:
  python generate_images.py --seed 42 --count 100 --output-dir data/assets/raw_images/
"""
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/assets/raw_images"),
