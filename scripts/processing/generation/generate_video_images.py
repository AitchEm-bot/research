...
Usage:
  python generate_video_images.py --seed 100 --count 2 --output-dir data/assets/raw_images_for_videos/
"""
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        type=str,
        default="data/assets/raw_images_for_videos",
        help="Output directory for images (default: data/assets/raw_images_for_videos)"
    )

    args = parser.parse_args()

    # Log torch/CUDA environment
    utils.log_torch_environment()
