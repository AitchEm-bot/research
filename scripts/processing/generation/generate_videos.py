...
Usage:
  python generate_videos.py --seed 100 --count 2 --output-dir data/assets/raw_videos/
"""
...
def main():
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/assets/raw_videos"),
        help="Output directory for generated videos"
    )
    parser.add_argument(
        "--images-dir",
        type=Path,
        default=Path("data/assets/raw_images_for_videos"),
